...
public class RepositoryInvocationHandler implements InvocationHandler {
    ...
    public RepositoryInvocationHandler(Class iface, PersistenceContext ctx) throws InvalidRepositoryDefinitionException {
        try {
            ...
            this.methodHandlers = ThrowingStream
                    .of(Arrays.stream(iface.getMethods()), InvalidRepositoryDefinitionException.class)
            ...
            throw new InvalidRepositoryDefinitionException("Error while creating the repository for the interface %s".formatted(iface.getName()), ex);
        }
    }
    ...
    private RepositoryMethodInvocationHandler createMethodHandler(Method m) throws InvalidRepositoryDefinitionException {
        var name = m.getName();
