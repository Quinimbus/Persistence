...
public class GenericMethodTest {
    ...
    public void testGetActualReturnType() throws NoSuchMethodException {
        var getString = new GenericMethod(
                StringImpl.class,
                StringImpl.class.getMethod("getString"));
        var get1 = new GenericMethod(
                StringImpl.class,
                StringImpl.class.getMethod("get1"));
        var get2 = new GenericMethod(
                StringImpl.class,
                StringImpl.class.getMethod("get2"));
