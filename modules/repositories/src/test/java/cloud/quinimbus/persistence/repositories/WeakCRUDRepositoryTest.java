...
public class WeakCRUDRepositoryTest {
    ...
    public static interface BlogEntryCommentRepository
            extends WeakCRUDRepository<BlogEntryComment, String, BlogEntry> {}
    ...
    public void testCreateNewInstanceAndDelete() {
        ...
        var findOneResult =
                this.commentRepository.findOne(blogEntry, "firstComment").orElseThrow();
