...
public class FilterFactoryTest {
    ...
    public void testFromMap() {
        ...
        assertTrue(filters.stream().anyMatch(pf -> pf.equals(new FilterFactory.DefaultPropertyFilter("a", PropertyFilter.Operator.EQUALS, "text"))));
        assertTrue(filters.stream().anyMatch(pf -> pf.equals(new FilterFactory.DefaultPropertyFilter("b", PropertyFilter.Operator.EQUALS, 13))));
    }
