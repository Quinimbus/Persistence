...
public record DefaultEntityPropertyEntry(String key, Object value, EntityTypePropertyType type, boolean partial)
        implements StructuredObjectEntry<EntityTypePropertyType> {}
