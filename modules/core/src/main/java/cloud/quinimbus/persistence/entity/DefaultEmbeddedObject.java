...
@EqualsAndHashCode(exclude = {"parentType", "propertyType", "embeddedPropertyTypes"}, callSuper = true)
public class DefaultEmbeddedObject extends AbstractDefaultStructuredObject<EntityTypePropertyType> implements EmbeddedObject {
    ...
    public DefaultEmbeddedObject(String[] path, EntityType parentType, Map<String, Object> properties, EmbeddedPropertyType propertyType) {
        super(properties);
        this.path = path;
